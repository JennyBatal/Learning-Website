  ...
  export const blog = [
    {
      ...
      desc: "A company that specializes in integrating artificial intelligence solutions to help other companies improve and remain competitive in their industry.",
